...
public class TxTypeFeeDelegatedSmartContractExecution extends TxTypeFeeDelegate {
    ...
    public static TxTypeFeeDelegatedSmartContractExecution createTransaction(
            long chainId, TxType.Type type, BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit, String to,
            BigInteger value, String from, byte[] payload) {
        return new TxTypeFeeDelegatedSmartContractExecution(chainId, type, nonce, gasPrice, gasLimit, to, value, from,
                payload);
    }
    ...
    public static TxTypeFeeDelegatedSmartContractExecution decodeFromRawTransaction(byte[] rawTransaction) {
        try {
            ...
            TxTypeFeeDelegatedSmartContractExecution tx = TxTypeFeeDelegatedSmartContractExecution
                    .createTransaction(type, nonce, gasPrice, gasLimit, to, value, from, payload);
