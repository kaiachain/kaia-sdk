...
public class UrlConstants {
    ...
    public static final String RPC = System.getenv().getOrDefault("RPC", "https://public-en-kairos.node.kaia.io");

    public static final String CN_RPC = System.getenv().getOrDefault("CN_RPC", "https://public-node-api.klaytnapi.com/v1/cypress");

    public static final String GOVERNANCE_RPC= System.getenv().getOrDefault("GOVERNANCE_RPC", "https://public-en-kairos.node.kaia.io");
